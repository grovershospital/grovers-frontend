        ...
        <div className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-[1fr_auto_auto_auto]">
            ...
            <div className={'relative'}>
                <select
                    ...
                    className="appearance-none rounded-full border cursor-pointer border-neutral-300 bg-white px-6 py-2 text-sm text-brand-ink focus:border-brand-blue focus:outline-none focus:ring-1 focus:ring-brand-blue"
                >
                    {READ_STATES.map((r) => (
                ...
                <ChevronDown
                    className="pointer-events-none cursor-pointer absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-neutral-500"
                    strokeWidth={2}
                />
            </div>
        </div>
